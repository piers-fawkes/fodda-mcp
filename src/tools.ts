...
export const TOOL_VERSIONS = {
    ...
    get_domain_intelligence: "1.0.0",
    get_specialist_intelligence: "1.0.0",
    get_expert_intelligence: "1.0.0",
    ...
    // Expert Onboarding tools
    begin_expert_onboarding: "1.0.0",
    submit_basic_info: "1.1.0",
    submit_mcp_source: "1.0.0",
    finalize_byo_mcp_onboarding: "1.0.0",
    submit_expertise_analysis: "1.0.0",
    get_detected_themes: "1.0.0",
