...
const DEFAULT_PRICING: QueryPricing[] = [
    ...
    },
    {
        ...
        queryTypeName: 'Synthetic Analyst Consult',
        apiCallsCharged: 5,
        researchCalls: 4,
        overheadCalls: 1,
        mcpToolName: 'consult_analyst',
    ...
    },
    {
        ...
        queryTypeName: 'Human Agent Consult',
        apiCallsCharged: 1,
        researchCalls: 1,
        overheadCalls: 0,
        mcpToolName: 'consult_human_agent',
        meterInteractionType: 'human_agent_consult',
        isActive: true,
        includesSupplementals: false,
        absorbsGeminiCost: false,
    },
    ...
    },
    {
        ...
        queryTypeName: 'Earnings History',
        apiCallsCharged: 10,
        researchCalls: 1,
        overheadCalls: 0,
        mcpToolName: 'get_company_earnings',
    ...
    },
    {
        ...
        queryTypeName: 'Earnings Compare',
        apiCallsCharged: 15,
        researchCalls: 1,
        overheadCalls: 0,
        mcpToolName: 'get_company_earnings',
