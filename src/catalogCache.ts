    ...
    for (const a of analysts) {
        ...
        for (const targetGraphId of candidateGraphIds) {
            bridged.push({
                ...
                quality_checker_title: '',
                quality_checker_company: '',
                update_frequency: 'Weekly',
                domain: expertIn || 'Specialist Intelligence',
                version: '1.0.0',
...
const QUERY_EXPANSION_MAP: Record<string, string[]> = {
    ...
    drink: ['beverage', 'drink', 'food', 'cpg', 'retail', 'nightlife', 'hospitality'],
    mocktail: ['beverage', 'drink', 'food', 'hospitality', 'dining', 'nightlife', 'wellness'],
    mocktails: ['beverage', 'drink', 'food', 'hospitality', 'dining', 'nightlife', 'wellness'],
    vin: ['beverage', 'food', 'hospitality', 'dining'],
    sommelier: ['beverage', 'food', 'hospitality', 'dining', 'nightlife'],
    ...
    appliance: ['appliances', 'home', 'kitchen', 'consumer-electronics', 'retail'],
    appliances: ['appliances', 'home', 'kitchen', 'consumer-electronics', 'retail'],
    // Fashion & Apparel
