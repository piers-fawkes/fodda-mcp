...
export async function createServer(
    ...
    server.tool(
        ...
        'Targeted pull for macro/institutional data. Research workflows include this automatically; call directly only for standalone economic context. Gets institutional market data from up to 10 sources in a single call — the server automatically selects the most relevant sources based on your query and domain: economic indicators, trade data, product landscape, food economics, agricultural production, nutritional composition, commodity pricing, research signals, demographic surveys, and more. Returns categorized data blocks (demand_signals, economic_context, market_data, research_signals, demographic_context) with source attribution for citations. 5 API calls per standalone use.',
        {
